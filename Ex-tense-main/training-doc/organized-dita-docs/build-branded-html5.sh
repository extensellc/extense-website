...
mkdir -p "$OUTPUT_DIR/js" "$OUTPUT_DIR/css" "$OUTPUT_DIR/icons" "$OUTPUT_DIR/fonts"
cp "$PLUGIN_DIR/js/site.js" "$OUTPUT_DIR/js/"
cp "$PLUGIN_DIR/css/brand.css" "$OUTPUT_DIR/css/"
cp "$PLUGIN_DIR/css/fonts.css" "$OUTPUT_DIR/css/"
cp "$PLUGIN_DIR/fonts/"* "$OUTPUT_DIR/fonts/"
# PWA assets
cp "$PLUGIN_DIR/pwa/manifest.json" "$OUTPUT_DIR/"
cp "$PLUGIN_DIR/pwa/service-worker.js" "$OUTPUT_DIR/"
cp "$PLUGIN_DIR/pwa/icon.svg" "$OUTPUT_DIR/"
cp "$PLUGIN_DIR/pwa/icons/"* "$OUTPUT_DIR/icons/"
echo "  ✓ Assets copied (including PWA)"
