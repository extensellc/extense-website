...
- **D-3 — Hero subdeck blended `[DRAFT]`:** old opener + a number.
  *(Locked: **Option B** — "…scales from a 10-page quick-start to a
  50,000-page data package — and cuts translation cost 30–40%." Chosen for the
  proof-of-depth signal across both Fortune 500 and federal evaluators.)*
