...
| Company › Our Process | done | done | done | done | done | [our-process.md](our-process.md) |
| Resources › AI-Readiness | done | done | done | pending | – | [ai-readiness.md](ai-readiness.md) |
| Service template (×3)  | –         | –        | –         | –        | –           | – |
...
| Service › XML Engineering | done   | done     | done      | done     | done        | [xml-engineering.md](xml-engineering.md) |
